...
type Handler struct {
	...
	// previewable reports whether a thumbnail can be made for a name. Injected
...
// canPreview reports whether an entry has a thumbnail available.
func (h *Handler) canPreview(node store.Node) bool {
